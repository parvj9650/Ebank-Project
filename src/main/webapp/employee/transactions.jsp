...
<head>
    <meta charset="UTF-8">
    <title>All Transactions - eBankDB</title>
...
<div class="container">
    ...
    %>
        <div class="error-message">
            ⚠ Invalid Account ID format. Please enter a valid number.
        </div>
    <%
    }
    %>
    ...
    <div class="search-section">
        <form method="get" action="<%= contextPath %>/viewAllTransactions" class="search-form">
            ...
            <a href="<%= contextPath %>/viewAllTransactions?action=showAll" class="show-all-btn">📋 Show All Accounts</a>
        </form>
    </div>
    ...
    <div class="bottom-buttons">
        <a href="<%= contextPath %>/employee/dashboard.jsp" class="back-btn">← Back to Dashboard</a>
    </div>
</div>
