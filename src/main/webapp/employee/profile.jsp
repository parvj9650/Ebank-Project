...
<head>
    <meta charset="UTF-8">
    <title>Complete Employee Profile - eBankDB</title>
...
<div class="form-container">
    <div class="page-header">
        <h2>👔 Complete Employee Profile</h2>
    </div>

    <div class="form-box">
        <div class="info-note">
            <span>ℹ️</span>
            <span>Please provide your employment details.</span>
        </div>
        ...
        <form action="<%=request.getContextPath()%>/saveEmployeeProfile" method="post">
