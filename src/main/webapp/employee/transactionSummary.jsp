...
<head>
    <meta charset="UTF-8">
    <title>Transaction Summary - eBankDB</title>
...
<div class="container">
    ...
    <%
        } else if(error.equals("noTransactions")) {
    %>
        <div class="error-message">
            <span>⚠</span> No transactions found for the specified account.
        </div>
    <%
        }
    }
    ...
    <div class="search-section">
        <form method="get" action="transactionSummary" class="search-form">
            ...
            <a href="transactionSummary?action=showAll" class="show-all-btn">Show All Accounts</a>
        </form>
    </div>
