...
<head>
    <meta charset="UTF-8">
    <title>Create Manager Profile - eBankDB</title>
...
<div class="form-container">
    ...
    <div class="form-box">
        <div class="info-note">
            <span>ℹ️</span>
            <span>Please provide the manager's details.</span>
        </div>
        ...
        <form action="<%= request.getContextPath() %>/createManager" method="post">
    ...
    <div class="bottom-buttons">
        <a href="login.jsp" class="back-btn">← Back to Login Page</a>
    </div>
</div>
