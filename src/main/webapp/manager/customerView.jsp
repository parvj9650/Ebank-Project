...
<head>
    <meta charset="UTF-8">
    <title>Customer Details - Manager Panel</title>
    ...
    <div class="search-section">
        ...
        %>
            <div class="error-message">
                <span>⚠</span> Invalid Customer ID format. Please enter a valid number.
            </div>
        <%
            }
        }
        ...
        <form method="get" action="<%= request.getContextPath() %>/managerCustomerView" class="search-form">
            ...
            <a href="<%= request.getContextPath() %>/managerCustomerView?action=showAll" class="show-all-btn">Show All Customers</a>
        </form>
    </div>
            ...
            <tbody>
                ...
                %>
                    <tr>
                        ...
                        <td><%= row.get("phone") %></dt>
                        <td>
                            <% if(accountId != null && !"No Account".equals(accountId) && !"null".equals(String.valueOf(accountId))) { %>
                        ...
                        <td>
                            <% if(accountType != null && !"N/A".equals(accountType) && !"null".equals(String.valueOf(accountType))) { %>
                                <%= accountType %>
                            <% } else { %>
                        ...
                        <td>
                            <% if(balance != null && !"null".equals(String.valueOf(balance))) {
                        ...
                        <td>
                            <% if(accountStatus != null && !"No Account".equals(accountStatus) && !"null".equals(String.valueOf(accountStatus))) {
                        ...
                        <td>
                            <% if(branchName != null && !"N/A".equals(branchName) && !"null".equals(String.valueOf(branchName))) { %>
                                <%= branchName %>
                            <% } else { %>
                                <span class="badge-na">N/A</span>
                            <% } %>
