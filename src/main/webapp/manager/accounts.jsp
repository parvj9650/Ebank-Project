...
<head>
    <meta charset="UTF-8">
    <title>Manage Accounts - Manager Panel</title>
...
<div class="container">
    ...
    <div class="search-section">
        <form method="get" action="managerAccounts" class="search-form">
            ...
            <a href="managerAccounts?action=showAll" class="show-all-btn">Show All Accounts</a>
        </form>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                for(Account a : accounts){
                    ...
                    boolean isFrozen = "Frozen".equals(a.getStatus());
                    boolean isClosed = "Closed".equals(a.getStatus());
                %>
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <% if(!isFrozen && !isClosed) { %>
                                    <a href="managerAccountAction?action=freeze&accountId=<%=a.getAccountId()%>&currentSearchId=<%= currentAccountId != null ? currentAccountId : "" %>"
                                ...
                                <% if(!isActive && !isClosed) { %>
                                    <a href="managerAccountAction?action=activate&accountId=<%=a.getAccountId()%>&currentSearchId=<%= currentAccountId != null ? currentAccountId : "" %>"
                                ...
                                <% } %>
                                <% if(!isClosed) { %>
                                    <a href="managerAccountAction?action=close&accountId=<%=a.getAccountId()%>&currentSearchId=<%= currentAccountId != null ? currentAccountId : "" %>"
                                       class="action-link action-close"
                                       onclick="return confirm('Are you sure you want to close account #<%= a.getAccountId() %>? This action cannot be undone.')">
                                        Close
                                    </a>
                                <% } %>
                            </div>
